...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/herbal.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='herbal', help='save to project/name')
